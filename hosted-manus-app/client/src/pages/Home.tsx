  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f6f8fc] text-[#122033] dark:bg-[#111827] dark:text-[#edf4ff]">
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Converter home"><span className="brand-mark"><img src="/manus-storage/converter-transfer-logo_a3adb507.png" alt="" /><i /></span><span className="brand-word"><b>Converter</b><small>CBR/01</small></span></a>
      ...
      <main id="top">
        <section className="hero-grid">
          ...
          <div className="hero-art" aria-hidden="true"><img src="/manus-storage/converter-signal-ledger-hero_cae1a676.png" alt="" /><div className="hero-schematic"><span>01 SOURCE</span><b>PNG</b><i /><span>02 TARGET</span><b>WEBP</b><i /><span>03 OUTPUT</span></div></div>
        </section>
        ...
        <section className="workbench-section" id="workbench">
          ...
          <div className="workbench-grid">
            ...
            <aside className="side-rail"><div className="side-card visual-card"><div className="artifact-frame"><img src="/manus-storage/converter-image-workbench_ca08c40c.png" alt="Abstract file conversion illustration" /><span>FORMAT / LOCAL</span></div><div><span className="mini-label">HOSTED IMAGE MODES</span><h3>Convert, resize, compress.</h3><p>These modes run in the browser and retain the original converter’s direct download flow.</p></div></div><div className="side-card privacy-card"><div className="artifact-frame"><img src="/manus-storage/converter-privacy-device_4c9a1696.png" alt="Private device processing illustration" /><span>DEVICE / ONLY</span></div><div><span className="mini-label">YOUR PRIVACY</span><h3>No account. No file transfer.</h3><p>The hosted app does not send your selected image to a conversion server.</p></div></div></aside>
          </div>
        </section>
      ...
      <footer><a className="brand" href="#top"><span className="brand-mark"><img src="/manus-storage/converter-transfer-logo_a3adb507.png" alt="" /><i /></span><span className="brand-word"><b>Converter</b><small>CBR/01</small></span></a><p>Legacy tools retained · Hosted image modes expanded</p><button onClick={reset}><RotateCcw size={14} /> Reset workspace</button></footer>
    </div>
  );
}
